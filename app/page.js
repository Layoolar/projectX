...
export default function Home() {
    ...
    return (
        <main className={styles.main}>
            <h1>
                Unlock Your <span> Rewards </span> Today!
            </h1>
            <div>
                Complete activities, earn points, and unlock exclusive benefits!
            </div>
            ...
            {joinClicked && <JoinNow referralCode={referralCode} setReferralCode={setReferralCode} />}
        </main>
    );
}
...
const JoinNow = ({ referralCode, setReferralCode }) => {
    ...
    const { mutate: applyReferralCode, isLoading, isError, error } = useReferralCode();
    ...
    return (
        <div className={styles.JoinCon}>
            <div className={styles.Join}>
                ...
                />
                <div className="hoverBtn">
                    <button className={styles.button} onMouseDown={handleReferalcode} disabled={isLoading}>
